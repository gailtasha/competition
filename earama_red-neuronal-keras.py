...
# 
# En este apartado vamos a estar revisando como el tamaño de la red afecta el desempeño de la misma. Vamos a experimentar utilizando distinta cantidad de capas ocultas y de neuronas por capa.
# 
# La variable arquitectura es una lista de Python que sirve como parametro de la funcion model(arquitectura) para definir una red neuronal con una cantidad len(arquitectura) de capas ocultas, donde cada capa oculta l tiene una cantidad de neuronas arquitectura[l-1].
# 
# Por ejemplo, de configurar la variable arquitectura  de forma [5,10,20] tendremos una red neuronal con 3 capas ocultas, con 5, 10 y 20 capas respectivamente. 
